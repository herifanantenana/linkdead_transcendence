...
import { sessionsStatus, SessionStatusEnum } from "../../drizzle.type";
...
export const sessionsStatusEnum = pgEnum("sessions_status", sessionsStatus);
...
export const sessionsTable = pgTable(
	"sessions",
	{
		...
		status: sessionsStatusEnum("status").notNull().default(SessionStatusEnum.active),
		revokedAt,
		expiresAt,
		createdAt,
		updatedAt,
