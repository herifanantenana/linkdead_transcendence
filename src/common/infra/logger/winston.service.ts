...
export class WinstonLoggerService {
	...
	constructor(@Inject(LoggerConfig.KEY) private readonly loggerConfig: ConfigType<typeof LoggerConfig>) {
		this.initLogger(loggerConfig.level, loggerConfig.dir, loggerConfig.fileActive);
	}
	...
	private initLogger(level: string, dir: string, fileActive: boolean) {
		if (fileActive && !existsSync(dir)) {
